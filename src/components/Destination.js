...
const Destination = () => {
  return (
    <div className="destination">
      ...
      the crater is mere 45 minutes, and is easy enough for beginners. Guides
      ...
      hike can be dusty and hot, so plan for an early morning trip, and then
      ...
      <DestinationData
        ...
        but still good for a beginner mountaineer, check out Mt.Daguldul in San
        Juan Batangas. You'll start your hike from the beach and pass through tropical
        forest. different rock formations, and small streams. There's a small store halfway
        up the trail where you can take a break and drink buko juice and though
        the summit itself may not have the best view. the breeze is fantastic 
